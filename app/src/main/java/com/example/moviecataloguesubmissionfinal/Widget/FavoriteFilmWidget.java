...
public class FavoriteFilmWidget extends AppWidgetProvider {
    ...
    public static final String ITEM_EXTRA = "com.example.moviecataloguesubmissionfinal.ITEM_EXTRA";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(AppWidgetManager.ACTION_APPWIDGET_UPDATE)) {
            ...
            ComponentName name = new ComponentName(context, FavoriteFilmWidget.class);
            int[] widgetIds = manager.getAppWidgetIds(name);
